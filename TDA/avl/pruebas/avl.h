...
/* Se recorren de forma in-order todos los elementos del avl. Puede recibir una función visitar,
...
/* Crea un iterador para el avl, que lo recorre de forma in-order.
 * Pre: el avl fue creado.
