...
static void prueba_crear_hash_vacio(void)
{
...
static void prueba_iterar_hash_vacio(void)
{
    hash_t* hash = hash_crear(NULL);
...
static void prueba_hash_insertar(void)
{
    hash_t* hash = hash_crear(NULL);
...
static void prueba_hash_reemplazar(void)
{
    hash_t* hash = hash_crear(NULL);
...
static void prueba_hash_reemplazar_con_destruir(void)
{
...
static void prueba_hash_borrar(void)
{
    hash_t* hash = hash_crear(NULL);
...
static void prueba_hash_clave_vacia(void)
{
    hash_t* hash = hash_crear(NULL);
...
static void prueba_hash_valor_null(void)
{
    hash_t* hash = hash_crear(NULL);
...
static void prueba_hash_iterar(void)
{
    hash_t* hash = hash_crear(NULL);
