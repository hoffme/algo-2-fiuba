...
static void prueba_abb_volumen_pc(size_t largo, bool debug){
    abb_t* arbol = abb_crear(strcmp, NULL);
...
static void prueba_abb_iterar_volumen_pc(size_t largo) {
    abb_t* arbol = abb_crear(strcmp, NULL);
...
void pruebas_abb_alumno(void) {
    ...
    prueba_abb_volumen_pc(20, true);
    prueba_abb_volumen_mc(2097151, true); //utilizar valores de log_2(x) - 1
    prueba_abb_iterar();
    prueba_abb_iterar_volumen_pc(20);
}